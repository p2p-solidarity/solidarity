...
extension CloudKitGroupSyncManager {
    ...
    internal func createPublicGroup(name: String, description: String, coverImage: Data?, userID: CKRecord.ID) async throws -> GroupModel {
    ...
    internal func createPrivateGroup(name: String, description: String, coverImage: Data?, userID: CKRecord.ID) async throws -> GroupModel {
