                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 24) {
                        ...
                        VStack(alignment: .leading, spacing: 16) {
                            ...
                            VStack(spacing: 1) {
                                SimpleNodeRow(icon: "plus.circle.fill", title: "Create Group", subtitle: "Create a new CloudKit group") { activeSheet = .create }
                                SimpleNodeRow(icon: "link", title: "Invite via Link", subtitle: "Generate invite link for members") { activeSheet = .invite }
                            }
                        }
                        .padding(4)
                        .background(
