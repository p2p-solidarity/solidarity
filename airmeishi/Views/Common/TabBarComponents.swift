    ...
    ZStack(alignment: .bottom) {
      ...
      HStack {
        TabBarButton(
          ...
          title: "Glossary",
          isSelected: selectedTab == MainAppTab.glossary.rawValue,
          action: {
        ...
        TabBarButton(
          ...
          title: "Sharing",
          isSelected: selectedTab == MainAppTab.sharing.rawValue,
          action: {
        ...
        TabBarButton(
          systemName: "",
          title: "Sakura",
          isSelected: selectedTab == MainAppTab.shoutout.rawValue,
          customIcon: "sakura-white",
          action: {
        ...
        TabBarButton(
          systemName: "target",
          title: "ID",
          isSelected: selectedTab == MainAppTab.id.rawValue,
          action: {
        ...
        TabBarButton(
          ...
          title: "Settings",
          isSelected: selectedTab == MainAppTab.settings.rawValue,
          action: {
