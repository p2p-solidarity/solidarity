...
# The android tree lives at the attest package root (two levels up since the
# 2.0.0 nitro convergence moved this crate to attest/semaphore/rust/).
PACKAGE_ROOT="$(cd "${SCRIPT_DIR}/../.." && pwd)"
RUST_DIR="${SCRIPT_DIR}"
JNI_DIR="${PACKAGE_ROOT}/android/src/main/jniLibs"
KOTLIN_OUT="${PACKAGE_ROOT}/android/src/main/java"
