...
Pod::Spec.new do |s|
  ...
  # we wrap; CryptoKit ships the SecureEnclave + HKDF + AES-GCM primitives.
  s.frameworks = ['CryptoKit', 'Security', 'Foundation', 'LocalAuthentication']
  ...
  load File.join(__dir__, 'nitrogen', 'generated', 'ios', 'SecretsVault+autolinking.rb')
