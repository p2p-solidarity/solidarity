...
namespace margelo::nitro::solidarity::nfcpassport {
  ...
  public:
    ...
    explicit HybridNfcPassportSpecSwift(const NfcPassport::HybridNfcPassportSpec_cxx& swiftPart):
      HybridObject(HybridNfcPassportSpec::TAG),
      _swiftPart(swiftPart) { }

  public:
    // Get the Swift part
    inline NfcPassport::HybridNfcPassportSpec_cxx& getSwiftPart() noexcept {
      return _swiftPart;
    }
