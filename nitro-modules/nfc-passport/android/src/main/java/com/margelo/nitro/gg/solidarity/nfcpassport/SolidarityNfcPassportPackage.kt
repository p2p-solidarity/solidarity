/*
 * SolidarityNfcPassportPackage.kt
 ...
 *   2. Trigger NfcPassportOnLoad.initializeNative() in the class
 *      initializer so the nitrogen-generated JNI registers the
 *      "NfcPassport" HybridObject before JS imports it.
 */
...
class SolidarityNfcPassportPackage : BaseReactPackage() {
  ...
  companion object {
    init {
      NfcPassportOnLoad.initializeNative()
    }
  }
}
