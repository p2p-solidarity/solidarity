...
namespace margelo::nitro::solidarity::keystone {
  ...
  public:
    ...
    explicit HybridSpruceDidSpecSwift(const Keystone::HybridSpruceDidSpec_cxx& swiftPart):
      HybridObject(HybridSpruceDidSpec::TAG),
      _swiftPart(swiftPart) { }

  public:
    // Get the Swift part
    inline Keystone::HybridSpruceDidSpec_cxx& getSwiftPart() noexcept {
      return _swiftPart;
    }
  ...
  private:
    Keystone::HybridSpruceDidSpec_cxx _swiftPart;
  };
