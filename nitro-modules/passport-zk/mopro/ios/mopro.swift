...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_passport_zk_mopro_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_passport_zk_mopro_rustbuffer_free(self, $0) }
    }
}
...
private func makeRustCall<T, E: Swift.Error>(
    ...
    uniffiEnsurePassportZkMoproInitialized()
...
#if compiler(>=6)
extension NoirProofResult: Sendable {}
#endif


extension NoirProofResult: Equatable, Hashable {
    public static func ==(lhs: NoirProofResult, rhs: NoirProofResult) -> Bool {
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeNoirProofResult: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> NoirProofResult {
        return
            try NoirProofResult(
                proof: FfiConverterData.read(from: &buf), 
                vk: FfiConverterData.read(from: &buf)
        )
    }

    public static func write(_ value: NoirProofResult, into buf: inout [UInt8]) {
        FfiConverterData.write(value.proof, into: &buf)
        FfiConverterData.write(value.vk, into: &buf)
    }
}
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeNoirProofResult_lift(_ buf: RustBuffer) throws -> NoirProofResult {
    return try FfiConverterTypeNoirProofResult.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeNoirProofResult_lower(_ value: NoirProofResult) -> RustBuffer {
    return FfiConverterTypeNoirProofResult.lower(value)
}
...
public struct FfiConverterTypeMoproError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> MoproError {
        ...
        case 1: return .CircuitError(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 2: return .ProofGenerationError(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 3: return .VerificationError(
            message: try FfiConverterString.read(from: &buf)
        )
    ...
    public static func write(_ value: MoproError, into buf: inout [UInt8]) {
        ...
        case .CircuitError(_ /* message is ignored*/):
            writeInt(&buf, Int32(1))
        case .ProofGenerationError(_ /* message is ignored*/):
 ...
 */
public func generateNoirProof(circuitPath: String, srsPath: String?, inputs: [String: [String]])throws  -> NoirProofResult  {
    return try  FfiConverterTypeNoirProofResult_lift(try rustCallWithError(FfiConverterTypeMoproError_lift) {
    uniffi_passport_zk_mopro_fn_func_generate_noir_proof(
...
public func getNoirVerificationKey(circuitPath: String, srsPath: String?)throws  -> Data  {
    ...
    uniffi_passport_zk_mopro_fn_func_get_noir_verification_key(
        FfiConverterString.lower(circuitPath),
...
public func verifyNoirProof(proof: Data, vk: Data)throws  -> Bool  {
    ...
    uniffi_passport_zk_mopro_fn_func_verify_noir_proof(
        FfiConverterData.lower(proof),
        FfiConverterData.lower(vk),$0
    )
})
}
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_passport_zk_mopro_checksum_func_get_noir_verification_key() != 62500) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_passport_zk_mopro_checksum_func_verify_noir_proof() != 537) {
        return InitializationResult.apiChecksumMismatch
    }
