...
final class GroupCredentialDeliveryService: ObservableObject {
  ...
  func sendCredential(
    ...
    case .proximity:
      ...
      throw GroupCredentialDeliveryError.deliveryError(
        "Proximity delivery requires direct peer interaction. Please use the Proximity view."
      )
    case .qrCode:
  ...
  private func sendViaSakura(
    ...
    guard let sealedRoute = member.sealedRoute,
      ...
      let signPubKey = member.signPubKey
    else {
